...
g.test_space_upgrade = function()
    ...
    g.server:eval("_ = t1:upgrade({mode = 'notest', func = 'upgrade_func', format = new_format, background = true})")
    g.server:eval("_ = t2:upgrade({mode = 'test', func = 'upgrade_func', format = new_format, background = true})")
    g.server:eval("_ = t3:upgrade({mode = 'notest', func = 'error_func', format = new_format, background = true})")
    g.server:eval("_ = t4:upgrade({mode = 'notest', func = 'error_delayed_func', format = new_format, background = true})")
